...
@interface RE_BoxScene(Private) 
-(void) setupPhysicsWorld;
@end

@implementation RE_BoxScene
...
-(id) init
{
	if( (self=[super init])) {
        ...
        player = [Player spriteWithBatchNode:sheet rect:r];
        ...
        playerb = [Player spriteWithBatchNode:sheet rect:r];
